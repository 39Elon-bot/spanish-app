...
function renderHome() {
  ...
  $screen.appendChild(el(`
    <div class="hero">
      ...
      <a href="repaso/" style="display:inline-block;margin-top:8px;background:rgba(255,255,255,.18);color:#fff;text-decoration:none;font-weight:700;font-size:.85rem;padding:8px 14px;border-radius:999px;border:1px solid rgba(255,255,255,.35)">🔁 習った言葉だけ聞き流し(¡Repasa!)→</a>
    </div>
  `));
